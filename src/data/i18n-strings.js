export const STATIC_UI = {
 ...
 // 카드에서 연다(src/ui/seniorMode.js). circuitProgressFmt·circuitNextBtn·
 // circuitFinishBtn·circuitDoneTime·amrapPauseBtn·amrapResumeBtn·
 // amrapQuitConfirm·quitConfirmSaved·amrapConfirmBtn·secUnit 은 기존 것을
 // 그대로 재사용한다(새로 안 만든다).
 seniorModeTitle: {ko:'어르신·재활 모드', en:'Senior & rehab mode', zh:'长者与康复模式'},
