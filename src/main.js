...
import { initSeniorMode } from './ui/seniorMode.js';
...
// 어르신·재활 모드(2026-09-27) — 위와 같은 이유(app.js 는 이 화면을 모른다).
initSeniorMode({ translate: t, STATIC_UI, onShowScreen: showScreenById });
